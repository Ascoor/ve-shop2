...
const ResponsiveNavbar = () => {
  ...
  return (
    <Fragment>
      <div className="flex items-center justify-between px-4 py-2  bg-[var(--color-primary-day)] dark:bg-[var(--color-primary-night)] text-[var(--color-secondary-day)] dark:text-[var(--color-secondary-night)]  shadow-md">
        <div className="flex items-center w-full justify-between">
          ...
          <div
            onClick={handleNav}
            className="md:hidden text-[var(--color-text-day)] dark:text-[var(--color-text-night)]"
          >
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <Link
              href="/cart"
              className="relative flex items-center text-[var(--color-primary-day)] dark:text-[var(--color-text-night)]"
              onClick={handleLinkClick}
            >
            ...
            <button
              ...
              className="text-[var(--color-primary-day)] dark:text-[var(--color-secondary-night)] hover:bg-[var(--color-button-hover-day)] dark:hover:bg-[var(--color-button-hover-night)] p-2 rounded-md"
            >
              {isDarkMode ? (
            ...
            {user ? (
              <div className="flex items-center gap-2">
                ...
                <button
                  onClick={logoutUser}
                  className="bg-[var(--color-primary-day)] dark:bg-[var(--color-primary-night)] text-[var(--color-secondary-day)] dark:text-[var(--color-secondary-night)] font-semibold py-2 px-4 rounded-md hover:bg-[var(--color-button-hover-day)] dark:hover:bg-[var(--color-button-hover-night)]"
                >
                  تسجيل الخروج
                </button>
              </div>
                      ...
                      {({ open }) => (
                        <>
                          <Disclosure.Button className="flex items-center w-full py-2 text-[var(--color-text-day)] dark:text-[var(--color-text-night)] hover:text-[var(--color-primary-day)] dark:hover:text-[var(--color-primary-night)] focus:outline-none">
                            ...
                            <ChevronRightIcon
                              className={`w-5 h-5 text-[var(--color-text-day)] dark:text-[var(--color-text-night)] transform transition-transform duration-300 ${open ? 'rotate-90' : ''}`}
                            />
                          </Disclosure.Button>
              ...
              <div className="flex flex-col items-center mt-4">
                {user ? (
                  <div className="flex flex-col items-center">
                    ...
                    <span className="text-lg font-semibold text-[var(--color-text-day)] dark:text-[var(--color-text-night)] mt-2">
                      {user.name}
                    </span>
                    <button
                      onClick={logoutUser}
                      className="bg-[var(--color-primary-day)] dark:bg-[var(--color-primary-night)] text-[var(--color-secondary-day)] dark:text-[var(--color-secondary-night)] font-semibold text-sm py-2 px-4 rounded-md mt-4 hover:bg-[var(--color-button-hover-day)] dark:hover:bg-[var(--color-button-hover-night)]"
                    >
                      تسجيل الخروج
                    </button>
                  </div>
