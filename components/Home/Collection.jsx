...
const Collection = ({ womenProducts }) => {
  return (  <div dir="rtl" className=' space-y-4 w-full flex flex-col  gap-6 '>
    ...
    <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl tracking-wide font-semibold text-center mt-4">
  خصومات كبيرة
</h1>
