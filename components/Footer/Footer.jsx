...
const Footer = () => {
  ...
  return (
    <footer className='bg-[var(--color-primary-day)] dark:bg-[var(--color-primary-night)] text-[var(--color-secondary-day)] dark:text-[var(--color-secondary-night)] py-8'>
      {!isAdminOrEmployee && (
          ...
          <div className='grid gap-10 row-gap-6 sm:grid-cols-2 lg:grid-cols-4 px-6'>
            ...
            <div>
              ...
              <div className='flex items-center mt-2 space-x-3 rtl:space-x-reverse'>
                <Link
                  href='/'
                  className='text-[var(--color-secondary-day)] dark:text-[var(--color-secondary-night)] transition-colors duration-300 hover:text-[var(--button-hover-background-color)]'
                >
