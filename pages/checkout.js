...
const Checkout = () => {
  ...
  return (
    <div className='bg-gray-100'>    <div className='flex flex-col md:flex-row w-full p-6 gap-5 justify-between'>
    <div className='w-full sm:px-0'>
      <div className='border-4 border-gray-200 rounded-lg'>
        <Tab.Group as='div' className='border-b border-gray-200' selectedIndex={selectedIndex} onChange={setSelectedIndex}>
          <Tab.List className='flex p-1 space-x-1 bg-gray-200'>
            <Tab className={({ selected }) => classNames(
              ...
              selected ? "bg-[#E43038] text-white shadow" : " hover:bg-gray-50"
            )}>
              <span className='flex items-center justify-center'>
                <span className='ml-3'>التفاصيل الشخصية</span>
              </span>
            </Tab>
            <Tab className={({ selected }) => classNames(
              "w-full py-2.5 text-sm leading-5 font-medium text-gray-900 rounded-lg",
              ...
              <span className='flex items-center justify-center'>
                <span className='ml-3'>الدفع</span>
              </span>
            </Tab>
          </Tab.List>
                  ...
                  <div className='bg-white shadow overflow-hidden sm:rounded-lg'>
                    <div className='px-4 py-5 sm:px-6'>
                      <h3 className='text-lg leading-6 font-medium text-gray-900'>
                        ملء تفاصيل الشحن الخاصة بك
                      </h3>
                    </div>
                    <div className='w-full md:w-2/3 md:max-w-full mx-auto'>
                      <div className='p-6 border border-gray-300 sm:rounded-md'>
                        <Formik
                          initialValues={عنوان_القيمة}
                          validationSchema={schema_العنوان}
                          onSubmit={تقديم_العنوان}
                        >
                          <Form>
                  ...
                  <div className='bg-white shadow overflow-hidden sm:rounded-lg'>
                   ...
                   بيانات الدفع
                    ...
                    <div>
                      ...
                      بالنقر على الزر، فإنك توافق على لدينا{" "}
                        <span
                          href='#'
