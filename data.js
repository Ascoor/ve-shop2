...
export const bestSellers = [
  {
    ...
    price: 79.99,
    description:
      'حقيبة مثالية للاستخدام اليومي والمشي في الغابة. قم بتخزين الكمبيوتر المحمول (حتى 15 بوصة) في الجراب المبطن، حقيبتك اليومية.',
    rating: {
      rate: 4.8,
      count: 250,
    },
  ...
  },
  {
    ...
    description:
      'تصميم ملائم لشكل الجسم، وأكمام طويلة من قماش راجلان بلون متباين، وفتحة هنلي بثلاثة أزرار، وقماش خفيف الوزن وناعم لارتداء مريح وجيد التهوية. وقمصان مخيطة بشكل متين مع رقبة مستديرة مصنوعة من أجل المتانة ومناسبة تمامًا للارتداء في الموضة غير الرسمية ومحبي البيسبول المتحمسين. يتضمن خط العنق المستدير على طراز هنلي فتحة بثلاثة أزرار.',
    price: 22.3,
  ...
  },
  {
    ...
    description:
      'سترات خارجية رائعة للربيع/الخريف/الشتاء، مناسبة للعديد من المناسبات، مثل العمل، والمشي لمسافات طويلة، والتخييم، وتسلق الجبال/الصخور، وركوب الدراجات، والسفر أو الأنشطة الخارجية الأخرى. اختيار هدية جيد لك أو لعضو عائلتك. حب دافئ للأب أو الزوج أو الابن في عيد الشكر أو عيد الميلاد هذا.',
    price: 55.99,
  ...
  },
  {
    ...
    description:
      'قد يختلف اللون قليلاً بين ما يظهر على الشاشة وفي الممارسة العملية. يرجى ملاحظة أن أشكال الجسم تختلف باختلاف الشخص، لذلك يجب مراجعة معلومات الحجم التفصيلية أدناه في وصف المنتج.',
    price: 15.99,
  ...
  },
  {
    ...
    description:
      'الرضا مضمون. إرجاع أو استبدال أي طلب خلال 30 يومًا من تصميم مركز حفيظ وبيعه في الولايات المتحدة. الرضا مضمون. إرجاع أو استبدال أي طلب خلال 30 يومًا.',
    price: 168.0,
  ...
  },
  {
    ...
    description:
      'خاتم وعد كلاسيكي من سوليتير الماسي لخطوبة الزفاف من أجلها. هدايا لتفسد حبك أكثر للخطوبة، الزفاف، الذكرى السنوية، عيد الحب...',
    price: 9.99,
  ...
  },
  {
    ...
    description:
      'أقراط أذن مزدوجة مطلية بالذهب الوردي، مصنوعة من الفولاذ المقاوم للصدأ 316L',
    price: 10.99,
  ...
  },
  {
    ...
    description:
      'من مجموعة الأساطير لدينا، استوحينا تصميم Naga من تنين الماء الأسطوري الذي يحمي لؤلؤ المحيط. ارتدِ هذا الخاتم مواجهًا للداخل لتنعم بالحب والوفرة، أو مواجهًا للخارج للحماية.',
    price: 10.99,
...
export const womenProducts = [
  ...
  },
  {
    ...
    category: 'ملابس نسائية',
    title:
      'سترة موتو بايكر النسائية من الجلد الصناعي بغطاء للرأس وقابلة للإزالة من Lock and Love',
    rating: {
      rate: 5, // "NaN" تم تحويله إلى 0
      count: 340,
    },
    description:
      '100% بولي يوريثين (الغلاف) 100% بوليستر (البطانة) 75% بوليستر 25% قطن (سترة)، مادة جلدية صناعية للأناقة والراحة / جيبان في الأمام، سترة من الجلد الصناعي بغطاء رأس 2 مقابل واحد، تفاصيل أزرار على الخصر / خياطة تفصيلية على الجانبين، يُغسل يدويًا فقط / لا تستخدم المبيضات / يُجفف بالتعليق / لا يُكوى',
    price: 29.95,
  ...
  },
  {
    ...
    description:
      '95% رايون 5% سباندكس، مصنوع في الولايات المتحدة الأمريكية أو مستورد، لا تستخدم المبيضات، نسيج خفيف الوزن مع تمدد رائع للراحة، مضلع على الأكمام وخط الرقبة / خياطة مزدوجة على الحاشية السفلية',
    price: 9.85,
  ...
  },
  {
    ...
    description:
      '95% قطن، 5% سباندكس، المميزات: كاجوال، أكمام قصيرة، طباعة حروف، رقبة على شكل حرف V، تي شيرت عصري، القماش ناعم وبه بعض المرونة، المناسبة: كاجوال/مكتب/شاطئ/مدرسة/منزل/شارع. الموسم: الربيع، الصيف، الخريف، الشتاء.',
    price: 12.99,
